...
Windows usage:
    python train_custom_mt_button_push_subproc.py

Quick test:
    python train_custom_mt_button_push_subproc.py --timesteps 500000 --n-envs 8

Full run:
    python train_custom_mt_button_push_subproc.py --timesteps 10000000 --n-envs 8

Run a more conservative PPO config:
    python train_custom_mt_button_push_subproc.py --combo careful --timesteps 10000000 --n-envs 8

TensorBoard:
    tensorboard --logdir ./subproc_runs_custom_mt_button_push
"""
...
DEFAULT_TASKS = ("button-press-v3", "push-v3")
DEFAULT_SEED = 42
...
CONFIGS: Dict[str, PPOConfig] = {
    "base": PPOConfig(
        run_name="custom_mt_button_push_PPO_10M_base",
        learning_rate=1e-4,
    ...
    "careful": PPOConfig(
        run_name="custom_mt_button_push_PPO_10M_careful",
        learning_rate=3e-5,
        n_steps=2048,
        batch_size=1024,
        n_epochs=15,
    ...
    "explore": PPOConfig(
        run_name="custom_mt_button_push_PPO_10M_explore",
        learning_rate=2e-4,
        n_steps=2048,
        batch_size=1024,
        n_epochs=10,
...
class CustomMTButtonPushEnv(gym.Env):
    """
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Train PPO on a custom button-press-v3 + push-v3 Meta-World environment."
    )
    ...
    parser.add_argument(
        "--output-dir",
        default="./subproc_runs_custom_mt_button_push",
